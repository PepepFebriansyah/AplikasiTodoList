...
public class AplikasiToDoList {
    ...
    public static void testShowTodoList(){
        ...
        model[0] = "Studi Kasus Java Dasar : Aplikasi Todolist";
        showTodoList();
    }
    ...
    public static void addTodoList(String todo){
        ...
        // Jika penuh, kitaresize ukuran array 2x lipat
        if (isFull){
           String[] temp = model;
        ...
        // tambahan ke posisi yang data array nya NULL
        for (int i = 0; i < model.length; i++){
            if (model [i] == null){
               model[i] = todo;
               break;
